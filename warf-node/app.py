...
def _call_warf_broker(address: str, pattern: List[float],
    ...
    The broker runs PCF scoring and returns the winner.

    We submit a single-agent arbitration round: if this artifact wins
    against the existing registry entry for this address (or is new),
    it earns its deposit. Score threshold: must exceed 0.5.
    """
    payload = json.dumps({
